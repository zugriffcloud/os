...
Static Web Applications do not run on the server; they run in the browser. Deploying a Static Web
Application can be as simple as executing the following command.
...
<i>
  You might want to look into catching 404s using interceptors. TLDR;
  `--intercept 404:/404.html`.
</i>
:::
